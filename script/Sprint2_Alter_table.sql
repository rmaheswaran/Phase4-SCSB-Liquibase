...
ALTER TABLE ITEM_T ADD COLUMN `LEGACY_OWNING_INST_ITEM_ID` VARCHAR(45) COLLATE utf8mb4_unicode_ci;
...
WHERE OWNING_INST_ID= (SELECT INSTITUTION_ID FROM INSTITUTION_T WHERE INSTITUTION_CODE='PUL');
